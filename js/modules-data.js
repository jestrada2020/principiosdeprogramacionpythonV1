...
app = App(app_ui, server)
        ...
        practiceContent: `
            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h3 class="text-2xl font-bold theme-text-primary mb-2">📘 Guía Práctica: de input() a funciones con def</h3>
                <p class="theme-text-secondary mb-4">Conjunto estructurado de ejercicios y retos pensados para ejecutarse en <strong>Google Colab</strong>. Va desde la captura de datos con <code>input()</code> y la aritmética básica, hasta la manipulación de cadenas, el uso de <code>time</code> para medir tiempos de respuesta, y la creación de <strong>funciones definidas por el usuario (<code>def</code>)</strong> para resolver fórmulas de física (MRUV, caída libre y tiro parabólico) y cálculos geométricos de áreas y volúmenes — todo sin usar condicionales (<code>if/else</code>).</p>
            ...
            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-3">1. Primeros pasos en Google Colab</h4>
                <ol class="list-decimal list-inside theme-text-secondary space-y-1 mb-2">
                    <li>Accede a <a href="https://colab.research.google.com/" target="_blank" rel="noopener noreferrer" class="text-blue-500 underline">colab.research.google.com</a> e inicia sesión con tu cuenta de Google.</li>
                    <li>Crea un <strong>Nuevo cuaderno</strong> (Notebook).</li>
                    <li>Crea celdas de código con el botón <strong>"+ Código"</strong> en la barra superior.</li>
                    <li>Escribe el código, ejecútalo con <kbd>Shift + Enter</kbd> y responde a lo que se te solicite en pantalla.</li>
                </ol>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-3">2. Variables y salida de datos</h4>
                <p class="theme-text-secondary mb-3">Las variables se declaran escribiendo su nombre y asignando un valor con <code>=</code>. Para combinar texto y variables en un mismo <code>print()</code> usamos <em>f-strings</em>.</p>
                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-blue-500 mb-2">
                    <h5 class="font-semibold theme-text-primary mb-2">📝 Ejercicio: Ficha de Datos Personales</h5>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code># Personaliza tu informacion
nombre = "Tu nombre aqui"
edad = 20
ciudad = "Tu ciudad"
lenguaje_favorito = "Python"

# Imprimir informacion usando f-strings
print(f"Hola, soy {nombre}")
print(f"Tengo {edad} anos")
print(f"Vivo en {ciudad}")
print(f"Mi lenguaje favorito es {lenguaje_favorito}")</code></pre></div>
                    <p class="text-sm theme-text-secondary mt-2">Cambia los valores por tus datos reales y agrega, por ejemplo, <code>profesion = "Estudiante"</code> al reporte impreso.</p>
                </div>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-3">3. Python como calculadora</h4>
                <p class="theme-text-secondary mb-3">Python soporta todas las operaciones aritméticas estándar directamente en sus expresiones.</p>
                <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code># Python como calculadora
...
print(f"Modulo (Residuo): 17 % 5 = {17 % 5}")</code></pre></div>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-3">4. Interacción con el usuario: input()</h4>
                <p class="theme-text-secondary mb-3"><code>input()</code> solicita información al usuario por teclado. Todo lo ingresado llega como una cadena de texto (<em>string</em>).</p>
                <div class="theme-bg-tertiary rounded-lg p-4 border-l-4 border-yellow-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">💡 Importancia de la conversión de tipos</h5>
                    <p class="text-sm theme-text-secondary">Para operar matemáticamente con datos ingresados hay que convertirlos con <code>int()</code> o <code>float()</code>. Si no lo haces, Python arrojará un error en operaciones aritméticas o simplemente concatenará los textos.</p>
                </div>
                <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code># Saludo interactivo
print("Hola desde Google Colab!")
nombre = input("Cual es tu nombre? ")
print(f"Bienvenido a Python, {nombre}!")</code></pre></div>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-3">5. El reloj del sistema y las cadenas de texto</h4>
                <div class="theme-bg-tertiary rounded-lg p-4 border-l-4 border-yellow-500">
                    <ul class="text-sm theme-text-secondary space-y-2">
                        <li><strong>Medición de tiempo con <code>time.time()</code>:</strong> tomando una marca de tiempo antes y otra después de interactuar con el usuario, podemos medir cuánto tardó en responder.</li>
                        <li><strong>Longitud de cadenas con <code>len()</code>:</strong> <code>len(texto)</code> devuelve la cantidad de caracteres de una cadena, incluyendo letras, números, símbolos y espacios.</li>
                    </ul>
                </div>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-3">6. Funciones definidas por el usuario (def)</h4>
                <p class="theme-text-secondary mb-3">Una <strong>función</strong> es un bloque de código reutilizable que realiza una tarea específica. En Python se define con <code>def</code>, seguido del nombre y los parámetros entre paréntesis.</p>
                <div class="theme-bg-tertiary rounded-lg p-4 border-l-4 border-yellow-500 mb-2">
                    <h5 class="font-semibold theme-text-primary mb-2">Sintaxis de una función</h5>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>def nombre_de_la_funcion(parametro1, parametro2):
    # Proceso o calculos utilizando los parametros
    resultado = parametro1 + parametro2
    return resultado # Devuelve el resultado al programa</code></pre></div>
                    <p class="text-sm theme-text-secondary mt-2">Definir la función no ejecuta su código de inmediato: hay que "llamarla" desde el flujo principal pasándole los valores requeridos.</p>
                </div>
                <p class="theme-text-secondary">A continuación, combinamos funciones con <code>input()</code> para capturar datos, <code>time</code> para medir el tiempo de respuesta, y f-strings con <code>:.3f</code> para mostrar resultados con exactamente tres cifras decimales.</p>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-4">7. Ejemplos resueltos: áreas geométricas con funciones</h4>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-green-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 1: Área de un Cuadrado</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> A = lado²</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time

# 1. Definicion de la funcion
def calcular_area_cuadrado(lado):
    return lado ** 2

# 2. Captura de datos y medicion del tiempo
print("--- Calculadora del Area de un Cuadrado ---")
tiempo_inicio = time.time()
lado_cuadrado = float(input("Ingresa el lado del cuadrado (en metros): "))
tiempo_fin = time.time()

# 3. Llamado a la funcion y calculo del tiempo
area = calcular_area_cuadrado(lado_cuadrado)
tiempo_total = tiempo_fin - tiempo_inicio

# 4. Impresion de resultados con 3 decimales
print(f"\\nEl area de un cuadrado de lado {lado_cuadrado:.3f} m es: {area:.3f} m2")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-green-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 2: Área de un Rectángulo</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> A = base × altura</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time

def calcular_area_rectangulo(base, altura):
    return base * altura

print("--- Calculadora del Area de un Rectangulo ---")
tiempo_inicio = time.time()
...
print(f"\\nEl area del rectangulo ({b:.3f} x {h:.3f}) es: {area:.3f}")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-green-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 3: Área de un Trapecio</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> A = ((B + b) · h) / 2</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time
...
tiempo_inicio = time.time()
B = float(input("Ingresa la base mayor (B): "))
b = float(input("Ingresa la base menor (b): "))
h = float(input("Ingresa la altura (h): "))
tiempo_fin = time.time()

area = calcular_area_trapecio(B, b, h)
tiempo_total = tiempo_fin - tiempo_inicio

print(f"\\nEl area del trapecio con bases {B:.3f} y {b:.3f} y altura {h:.3f} es: {area:.3f}")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-green-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 4: Área de un Círculo</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> A = π · r²</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time
import math # Importamos math para obtener el valor preciso de pi

def calcular_area_circulo(radio):
    return math.pi * (radio ** 2)

print("--- Calculadora del Area de un Circulo ---")
tiempo_inicio = time.time()
...
print(f"\\nEl area del circulo de radio {radio_circulo:.3f} es: {area:.3f}")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-green-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 5: Área de un Sector Circular</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> A = (π · r² · θ) / 360 (θ en grados sexagesimales)</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time
import math

def calcular_area_sector(radio, angulo):
    return (math.pi * (radio ** 2) * angulo) / 360

print("--- Calculadora del Area de un Sector Circular ---")
tiempo_inicio = time.time()
r = float(input("Ingresa el radio del sector circular: "))
theta = float(input("Ingresa el angulo (en grados sexagesimales): "))
tiempo_fin = time.time()

area = calcular_area_sector(r, theta)
tiempo_total = tiempo_fin - tiempo_inicio

print(f"\\nEl area del sector de radio {r:.3f} y angulo {theta:.3f} grados es: {area:.3f}")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-green-500">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 6: Área de una Elipse</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> A = π · a · b (a y b son los semiejes mayor y menor)</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time
import math
...
print("--- Calculadora del Area de una Elipse ---")
tiempo_inicio = time.time()
a = float(input("Ingresa la longitud del semieje mayor (a): "))
b = float(input("Ingresa la longitud del semieje menor (b): "))
tiempo_fin = time.time()

area = calcular_area_elipse(a, b)
tiempo_total = tiempo_fin - tiempo_inicio

print(f"\\nEl area de la elipse con semiejes ({a:.3f}, {b:.3f}) es: {area:.3f}")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-4">8. Ejemplos resueltos: volúmenes de sólidos</h4>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-purple-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 7: Volumen de un Cubo</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> V = lado³</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time
...
tiempo_inicio = time.time()
lado_cubo = float(input("Ingresa la arista o lado del cubo: "))
tiempo_fin = time.time()

volumen = calcular_volumen_cubo(lado_cubo)
tiempo_total = tiempo_fin - tiempo_inicio

print(f"\\nEl volumen de un cubo de lado {lado_cubo:.3f} es: {volumen:.3f}")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-purple-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 8: Volumen de un Prisma Rectangular</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> V = largo × ancho × alto</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time

def calcular_volumen_prisma(largo, ancho, alto):
    return largo * ancho * alto

print("--- Calculadora de Volumen de Solido Rectangular ---")
tiempo_inicio = time.time()
l = float(input("Ingresa el largo del solido: "))
w = float(input("Ingresa el ancho del solido: "))
h = float(input("Ingresa la altura del solido: "))
tiempo_fin = time.time()

volumen = calcular_volumen_prisma(l, w, h)
tiempo_total = tiempo_fin - tiempo_inicio

print(f"\\nEl volumen del solido ({l:.3f} x {w:.3f} x {h:.3f}) es: {volumen:.3f}")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-purple-500">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 9: Volumen de un Cono</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> V = (π · r² · h) / 3</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time
import math
...
print("--- Calculadora del Volumen de un Cono ---")
tiempo_inicio = time.time()
radio_base = float(input("Ingresa el radio de la base del cono: "))
altura_cono = float(input("Ingresa la altura del cono: "))
tiempo_fin = time.time()

volumen = calcular_volumen_cono(radio_base, altura_cono)
tiempo_total = tiempo_fin - tiempo_inicio

print(f"\\nEl volumen del cono con radio {radio_base:.3f} y altura {altura_cono:.3f} es: {volumen:.3f}")
print(f"Tardaste {tiempo_total:.2f} segundos en responder.")</code></pre></div>
                </div>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6 mb-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-4">9. Ejemplos resueltos: fórmulas de física del movimiento</h4>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-red-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 10: Movimiento Rectilíneo Uniformemente Variado (MRUV)</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula de distancia recorrida:</strong> d = v0 · t + (1/2) · a · t²</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time

def calcular_distancia_mruv(v0, aceleracion, tiempo):
    return (v0 * tiempo) + (0.5 * aceleracion * (tiempo ** 2))

print("--- Evaluacion de Movimiento Rectilineo (MRUV) ---")
tiempo_inicio = time.time()
v0 = float(input("Ingresa la velocidad inicial (v0 en m/s): "))
a = float(input("Ingresa la aceleracion constante (a en m/s2): "))
t = float(input("Ingresa el intervalo de tiempo (t en segundos): "))
tiempo_fin = time.time()

distancia = calcular_distancia_mruv(v0, a, t)
tiempo_total = tiempo_fin - tiempo_inicio

print("\\n--- Resultados de Cinematica ---")
print(f"-> Velocidad Inicial: {v0:.3f} m/s")
print(f"-> Aceleracion: {a:.3f} m/s2")
print(f"-> Tiempo de recorrido: {t:.3f} s")
print(f"-> Distancia total recorrida: {distancia:.3f} metros")
print(f"Tiempo empleado para ingresar datos: {tiempo_total:.2f} segundos")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-red-500 mb-4">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 11: Caída Libre (altura alcanzada)</h5>
                    <p class="text-sm theme-text-secondary mb-2"><strong>Fórmula:</strong> h = (1/2) · g · t² (objeto soltado desde el reposo, g = 9.81 m/s²)</p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time

def calcular_altura_caida(tiempo):
    g = 9.81 # Aceleracion de la gravedad en m/s2
    return 0.5 * g * (tiempo ** 2)

print("--- Evaluacion de Caida Libre ---")
tiempo_inicio = time.time()
t = float(input("Ingresa el tiempo de caida libre (t en segundos): "))
tiempo_fin = time.time()

altura = calcular_altura_caida(t)
tiempo_total = tiempo_fin - tiempo_inicio

print(f"\\nLa altura recorrida por el objeto tras caida libre de {t:.3f} s es: {altura:.3f} metros")
print(f"Tiempo empleado para ingresar datos: {tiempo_total:.2f} segundos")</code></pre></div>
                </div>

                <div class="theme-bg-tertiary rounded-lg p-5 border-l-4 border-red-500">
                    <h5 class="font-semibold theme-text-primary mb-1">Reto 12: Movimiento Parabólico (Tiro Parabólico)</h5>
                    <p class="text-sm theme-text-secondary mb-2">
                        <strong>Alcance horizontal máximo:</strong> R = (v0² · sen(2θ)) / g<br>
                        <strong>Altura máxima alcanzada:</strong> H = (v0² · sen²(θ)) / (2g)
                    </p>
                    <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto"><pre><code>import time
import math

def evaluar_tiro_parabolico(v0, angulo_grados):
    g = 9.81
    # Convertir el angulo a radianes porque math.sin usa radianes
...
print("--- Evaluacion de Movimiento Parabolico ---")
tiempo_inicio = time.time()
v0 = float(input("Ingresa la velocidad de disparo inicial (v0 en m/s): "))
angulo = float(input("Ingresa el angulo de lanzamiento (en grados): "))
tiempo_fin = time.time()

alcance, alt_max = evaluar_tiro_parabolico(v0, angulo)
tiempo_total = tiempo_fin - tiempo_inicio

print("\\n--- Resultados del Tiro Parabolico ---")
print(f"-> Velocidad de lanzamiento: {v0:.3f} m/s")
print(f"-> Angulo de lanzamiento: {angulo:.3f} grados")
print(f"-> Alcance horizontal maximo (R): {alcance:.3f} metros")
print(f"-> Altura maxima alcanzada (H): {alt_max:.3f} metros")
print(f"Tiempo empleado para ingresar datos: {tiempo_total:.2f} segundos")</code></pre></div>
                </div>
            </div>

            <div class="theme-bg-secondary rounded-2xl p-6">
                <h4 class="text-xl font-semibold theme-text-primary mb-3">10. Ejercicios propuestos para crear</h4>
                <p class="theme-text-secondary mb-3">Escribe tu propio código en Google Colab para los siguientes problemas. En todos, define una función con <code>def</code>, mide el tiempo de respuesta con <code>time</code> y muestra resultados formateados con f-strings. Puedes ver estos ejercicios ya resueltos (junto con cinco retos adicionales) en la pestaña <strong>"Ejercicios"</strong> de este módulo.</p>
                <ol class="list-decimal list-inside theme-text-secondary space-y-3">
                    <li><strong>El reto del volumen de una esfera:</strong> define <code>calcular_volumen_esfera(radio)</code>. Solicita el radio por teclado, calcula V = (4/3)·π·r³ e imprime el volumen con 3 decimales junto al tiempo de respuesta.</li>
                    <li><strong>El reto de la energía cinética:</strong> define una función para evaluar Ec = (1/2)·m·v². Solicita la masa (kg) y la velocidad (m/s), calcula la energía en Joules y muestra el resultado con el tiempo de respuesta.</li>
                    <li><strong>El reto del período de un péndulo simple:</strong> define una función para T = 2π·√(L/g). Pide la longitud L (metros), usa g = 9.81 m/s² y muestra el período T.</li>
                </ol>
            </div>
        `,
        exercises: [
            ...
            },
            {
                ...
                description: "Define calcular_volumen_esfera(radio) con V = (4/3)*pi*r^3. Pide el radio por teclado, mide el tiempo de respuesta con time y muestra el volumen con 3 decimales.",
                template: "import time\nimport math\n\n# Define aqui la funcion calcular_volumen_esfera(radio)\n\n\nprint(\"--- Calculadora del Volumen de una Esfera ---\")\ntiempo_inicio = time.time()\nradio = float(input(\"Ingresa el radio de la esfera: \"))\ntiempo_fin = time.time()\n\n# Llama a la funcion, calcula el tiempo total e imprime el resultado con 3 decimales\n",
                solution: "import time\nimport math\n\ndef calcular_volumen_esfera(radio):\n    return (4/3) * math.pi * (radio ** 3)\n\nprint(\"--- Calculadora del Volumen de una Esfera ---\")\ntiempo_inicio = time.time()\nradio = float(input(\"Ingresa el radio de la esfera: \"))\ntiempo_fin = time.time()\n\nvolumen = calcular_volumen_esfera(radio)\ntiempo_total = tiempo_fin - tiempo_inicio\n\nprint(f\"\\nEl volumen de la esfera de radio {radio:.3f} es: {volumen:.3f}\")\nprint(f\"Tardaste {tiempo_total:.2f} segundos en responder.\")"
            },
            {
                title: "Reto: Energía cinética",
                description: "Define una funcion para Ec = (1/2)*m*v^2. Pide la masa (kg) y la velocidad (m/s), calcula la energia en Joules y muestra el tiempo de respuesta.",
                template: "import time\n\n# Define aqui la funcion calcular_energia_cinetica(masa, velocidad)\n\n\nprint(\"--- Calculadora de Energia Cinetica ---\")\ntiempo_inicio = time.time()\nmasa = float(input(\"Ingresa la masa del cuerpo (en kg): \"))\nvelocidad = float(input(\"Ingresa la velocidad del cuerpo (en m/s): \"))\ntiempo_fin = time.time()\n\n# Llama a la funcion, calcula el tiempo total e imprime el resultado con 3 decimales\n",
                solution: "import time\n\ndef calcular_energia_cinetica(masa, velocidad):\n    return 0.5 * masa * (velocidad ** 2)\n\nprint(\"--- Calculadora de Energia Cinetica ---\")\ntiempo_inicio = time.time()\nmasa = float(input(\"Ingresa la masa del cuerpo (en kg): \"))\nvelocidad = float(input(\"Ingresa la velocidad del cuerpo (en m/s): \"))\ntiempo_fin = time.time()\n\nenergia = calcular_energia_cinetica(masa, velocidad)\ntiempo_total = tiempo_fin - tiempo_inicio\n\nprint(f\"\\nLa energia cinetica de un cuerpo de masa {masa:.3f} kg a {velocidad:.3f} m/s es: {energia:.3f} Joules\")\nprint(f\"Tardaste {tiempo_total:.2f} segundos en responder.\")"
            },
            {
                title: "Reto: Período de un péndulo simple",
                description: "Define una funcion para T = 2*pi*sqrt(L/g) con g = 9.81 m/s^2. Pide la longitud L del pendulo (en metros) y muestra el periodo T con 3 decimales.",
                template: "import time\nimport math\n\n# Define aqui la funcion calcular_periodo_pendulo(longitud)\n\n\nprint(\"--- Calculadora del Periodo de un Pendulo Simple ---\")\ntiempo_inicio = time.time()\nlongitud = float(input(\"Ingresa la longitud del pendulo (en metros): \"))\ntiempo_fin = time.time()\n\n# Llama a la funcion, calcula el tiempo total e imprime el resultado con 3 decimales\n",
                solution: "import time\nimport math\n\ndef calcular_periodo_pendulo(longitud):\n    g = 9.81\n    return 2 * math.pi * math.sqrt(longitud / g)\n\nprint(\"--- Calculadora del Periodo de un Pendulo Simple ---\")\ntiempo_inicio = time.time()\nlongitud = float(input(\"Ingresa la longitud del pendulo (en metros): \"))\ntiempo_fin = time.time()\n\nperiodo = calcular_periodo_pendulo(longitud)\ntiempo_total = tiempo_fin - tiempo_inicio\n\nprint(f\"\\nEl periodo de un pendulo de longitud {longitud:.3f} m es: {periodo:.3f} segundos\")\nprint(f\"Tardaste {tiempo_total:.2f} segundos en responder.\")"
            },
            {
                title: "Reto: Volumen de un cilindro",
                description: "Define calcular_volumen_cilindro(radio, altura) con V = pi*r^2*h. Pide el radio y la altura del cilindro y muestra el volumen con 3 decimales.",
                template: "import time\nimport math\n\n# Define aqui la funcion calcular_volumen_cilindro(radio, altura)\n\n\nprint(\"--- Calculadora del Volumen de un Cilindro ---\")\ntiempo_inicio = time.time()\nradio = float(input(\"Ingresa el radio del cilindro: \"))\naltura = float(input(\"Ingresa la altura del cilindro: \"))\ntiempo_fin = time.time()\n\n# Llama a la funcion, calcula el tiempo total e imprime el resultado con 3 decimales\n",
                solution: "import time\nimport math\n\ndef calcular_volumen_cilindro(radio, altura):\n    return math.pi * (radio ** 2) * altura\n\nprint(\"--- Calculadora del Volumen de un Cilindro ---\")\ntiempo_inicio = time.time()\nradio = float(input(\"Ingresa el radio del cilindro: \"))\naltura = float(input(\"Ingresa la altura del cilindro: \"))\ntiempo_fin = time.time()\n\nvolumen = calcular_volumen_cilindro(radio, altura)\ntiempo_total = tiempo_fin - tiempo_inicio\n\nprint(f\"\\nEl volumen del cilindro de radio {radio:.3f} y altura {altura:.3f} es: {volumen:.3f}\")\nprint(f\"Tardaste {tiempo_total:.2f} segundos en responder.\")"
            },
            {
                title: "Reto: Área de un rombo",
                description: "Define calcular_area_rombo(diagonal_mayor, diagonal_menor) con A = (D*d)/2. Pide las dos diagonales del rombo y muestra el area con 3 decimales.",
                template: "import time\n\n# Define aqui la funcion calcular_area_rombo(diagonal_mayor, diagonal_menor)\n\n\nprint(\"--- Calculadora del Area de un Rombo ---\")\ntiempo_inicio = time.time()\nD = float(input(\"Ingresa la diagonal mayor (D): \"))\nd = float(input(\"Ingresa la diagonal menor (d): \"))\ntiempo_fin = time.time()\n\n# Llama a la funcion, calcula el tiempo total e imprime el resultado con 3 decimales\n",
                solution: "import time\n\ndef calcular_area_rombo(diagonal_mayor, diagonal_menor):\n    return (diagonal_mayor * diagonal_menor) / 2\n\nprint(\"--- Calculadora del Area de un Rombo ---\")\ntiempo_inicio = time.time()\nD = float(input(\"Ingresa la diagonal mayor (D): \"))\nd = float(input(\"Ingresa la diagonal menor (d): \"))\ntiempo_fin = time.time()\n\narea = calcular_area_rombo(D, d)\ntiempo_total = tiempo_fin - tiempo_inicio\n\nprint(f\"\\nEl area del rombo con diagonales {D:.3f} y {d:.3f} es: {area:.3f}\")\nprint(f\"Tardaste {tiempo_total:.2f} segundos en responder.\")"
            },
            {
                title: "Reto: Volumen de una pirámide de base cuadrada",
                description: "Define calcular_volumen_piramide(lado_base, altura) con V = (lado^2 * altura)/3. Pide el lado de la base y la altura de la piramide y muestra el volumen con 3 decimales.",
                template: "import time\n\n# Define aqui la funcion calcular_volumen_piramide(lado_base, altura)\n\n\nprint(\"--- Calculadora del Volumen de una Piramide de Base Cuadrada ---\")\ntiempo_inicio = time.time()\nlado = float(input(\"Ingresa el lado de la base cuadrada: \"))\naltura = float(input(\"Ingresa la altura de la piramide: \"))\ntiempo_fin = time.time()\n\n# Llama a la funcion, calcula el tiempo total e imprime el resultado con 3 decimales\n",
                solution: "import time\n\ndef calcular_volumen_piramide(lado_base, altura):\n    return ((lado_base ** 2) * altura) / 3\n\nprint(\"--- Calculadora del Volumen de una Piramide de Base Cuadrada ---\")\ntiempo_inicio = time.time()\nlado = float(input(\"Ingresa el lado de la base cuadrada: \"))\naltura = float(input(\"Ingresa la altura de la piramide: \"))\ntiempo_fin = time.time()\n\nvolumen = calcular_volumen_piramide(lado, altura)\ntiempo_total = tiempo_fin - tiempo_inicio\n\nprint(f\"\\nEl volumen de la piramide de base {lado:.3f} y altura {altura:.3f} es: {volumen:.3f}\")\nprint(f\"Tardaste {tiempo_total:.2f} segundos en responder.\")"
            },
            {
                title: "Reto: Fuerza de gravitación universal",
                description: "Define calcular_fuerza_gravitacional(masa1, masa2, distancia) con F = G*m1*m2/d^2, usando G = 6.674e-11. Pide las dos masas (kg) y la distancia entre ellas (m) y muestra la fuerza resultante.",
                template: "import time\n\n# Define aqui la funcion calcular_fuerza_gravitacional(masa1, masa2, distancia)\n# Usa la constante de gravitacion universal G = 6.674e-11\n\n\nprint(\"--- Calculadora de la Fuerza de Gravitacion Universal ---\")\ntiempo_inicio = time.time()\nm1 = float(input(\"Ingresa la masa del primer cuerpo (en kg): \"))\nm2 = float(input(\"Ingresa la masa del segundo cuerpo (en kg): \"))\nd = float(input(\"Ingresa la distancia entre los cuerpos (en metros): \"))\ntiempo_fin = time.time()\n\n# Llama a la funcion, calcula el tiempo total e imprime el resultado\n",
                solution: "import time\n\ndef calcular_fuerza_gravitacional(masa1, masa2, distancia):\n    G = 6.674e-11\n    return (G * masa1 * masa2) / (distancia ** 2)\n\nprint(\"--- Calculadora de la Fuerza de Gravitacion Universal ---\")\ntiempo_inicio = time.time()\nm1 = float(input(\"Ingresa la masa del primer cuerpo (en kg): \"))\nm2 = float(input(\"Ingresa la masa del segundo cuerpo (en kg): \"))\nd = float(input(\"Ingresa la distancia entre los cuerpos (en metros): \"))\ntiempo_fin = time.time()\n\nfuerza = calcular_fuerza_gravitacional(m1, m2, d)\ntiempo_total = tiempo_fin - tiempo_inicio\n\nprint(f\"\\nLa fuerza de atraccion entre los cuerpos de {m1:.3f} kg y {m2:.3f} kg a {d:.3f} m es: {fuerza:.3e} Newtons\")\nprint(f\"Tardaste {tiempo_total:.2f} segundos en responder.\")"
            },
            {
                title: "Reto: Potencia eléctrica",
                description: "Define calcular_potencia_electrica(voltaje, corriente) con P = V*I (Ley de Watt). Pide el voltaje (V) y la corriente (A) y muestra la potencia en Watts con 3 decimales.",
                template: "import time\n\n# Define aqui la funcion calcular_potencia_electrica(voltaje, corriente)\n\n\nprint(\"--- Calculadora de Potencia Electrica ---\")\ntiempo_inicio = time.time()\nvoltaje = float(input(\"Ingresa el voltaje del circuito (en Voltios): \"))\ncorriente = float(input(\"Ingresa la corriente del circuito (en Amperios): \"))\ntiempo_fin = time.time()\n\n# Llama a la funcion, calcula el tiempo total e imprime el resultado con 3 decimales\n",
                solution: "import time\n\ndef calcular_potencia_electrica(voltaje, corriente):\n    return voltaje * corriente\n\nprint(\"--- Calculadora de Potencia Electrica ---\")\ntiempo_inicio = time.time()\nvoltaje = float(input(\"Ingresa el voltaje del circuito (en Voltios): \"))\ncorriente = float(input(\"Ingresa la corriente del circuito (en Amperios): \"))\ntiempo_fin = time.time()\n\npotencia = calcular_potencia_electrica(voltaje, corriente)\ntiempo_total = tiempo_fin - tiempo_inicio\n\nprint(f\"\\nLa potencia electrica con {voltaje:.3f} V y {corriente:.3f} A es: {potencia:.3f} Watts\")\nprint(f\"Tardaste {tiempo_total:.2f} segundos en responder.\")"
            },
        ],
        quiz: [
            {
